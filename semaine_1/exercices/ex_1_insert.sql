...
INSERT INTO consultations (numero, date_consult, type_consult, prix, matricule, num_assure) VALUES (NICOLAS_HENRY.SEQ_CONSULTATION.NEXTVAL, TO_DATE('2025-09-18', 'YYYY-MM-DD'), 'G', 50, 1, 1001);
INSERT INTO consultations (numero, date_consult, type_consult, prix, matricule, num_assure) VALUES (NICOLAS_HENRY.SEQ_CONSULTATION.NEXTVAL, TO_DATE('2025-09-17', 'YYYY-MM-DD'), 'P', 70, 2, 1002);
INSERT INTO consultations (numero, date_consult, type_consult, prix, matricule, num_assure) VALUES (NICOLAS_HENRY.SEQ_CONSULTATION.NEXTVAL, TO_DATE('2025-09-16', 'YYYY-MM-DD'), 'G', 60, 3, 1003);
COMMIT;
